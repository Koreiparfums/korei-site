...
(function (global) {
  ...
  const PRODUCT_CATALOG = [
    ...
    createProduct({
      ...
      name: "Imagination",
      notesTop: ["Bergamote", "Ambrette"],
      notesHeart: ["Ambroxan"],
      notesBase: ["Vanille de Madagascar", "Bois de cachemire"],
      family: "boisé",
      gender: "homme",
      intensity: "intense",
      occasions: ["soirée", "bureau"],
    ...
    createProduct({
      ...
      brandId: "dior",
      name: "Oud Ispahan",
      notesTop: ["Rose de Damas"],
      notesHeart: ["Oud", "Safran"],
      notesBase: ["Patchouli"],
      family: "oriental",
      gender: "unisexe",
      intensity: "intense",
    ...
    createProduct({
      ...
      brandId: "mancera",
      name: "Coco Vanille",
      notesTop: ["Noix de coco", "Ananas"],
      notesHeart: ["Jasmin", "Vanille"],
      notesBase: ["Musc", "Bois de santal"],
      family: "gourmand",
      gender: "femme",
      intensity: "intense",
      occasions: ["soirée", "date"],
